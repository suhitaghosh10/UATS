...
if USER_NAME == 'suhita':
    ENS_GT_PATH = '/data/suhita/temporal/skin/output/sm_mc/sadv22vvj2/'
...
if __name__ == '__main__':
    ...
    try:
        ...
        # train(None, None, perc=0.05, batch_nos=5, learning_rate=1e-6, wts='/data/suhita/skin/models/sm_skin_entropy_F'+str(FOLD_NUM)+'_Perct_Labelled_'+str(0.05)+'.h5')
        # cleanup()
