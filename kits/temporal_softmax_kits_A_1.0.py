...
TRAIN_NUM = len(np.load('/data/suhita/temporal/kits/Folds/train_fold' + str(FOLD_NUM) + '.npy'))
NAME = 'kits_softmax_F' + str(FOLD_NUM) + '_Perct_Labelled_' + str(PERCENTAGE_OF_LABELLED)
...
def train(gpu_id, nb_gpus):
    ...
    IMGS_PER_ENS_BATCH = num_un_labeled_train
...
if __name__ == '__main__':
    ...
    model_name = '/data/suhita/temporal/kits_softmax_F1_132_Perct_Labelled_0.1.h5'
    predict(model_name)
