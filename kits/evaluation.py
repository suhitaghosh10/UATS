...
def evaluateFiles_arr(prediction, GT_array, csvName, connected_component= False):
    with open(csvName, 'w') as csvfile:
        ...
        for imgNumber in range(0, nrImgs):
            ...
            GT_label = sitk.GetImageFromArray(GT_arr[imgNumber,:,:,:,0])
...
if __name__ == '__main__':
    ...
    out_dir = '/home/anneke/projects/uats/code/kits/output/'
    model_dir = out_dir +'/models'

    GT_dir = '/data/anneke/kits_challenge/kits19/data/preprocessed_labeled_test'
