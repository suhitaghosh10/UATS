...
class DataGenerator(keras.utils.Sequence):
    def __init__(self, imgs_path, gt_path, ensemble_path, supervised_flag_path, dice_path, id_list, batch_size=2,
                 dim=(32, 168, 168)):
        'Initialization'
        self.dim = dim
    ...
    def __data_generation(self, list_IDs_temp):
        ...
        dice = np.empty((self.batch_size, 1, 1, 1, 5))
        flag = np.zeros((self.batch_size, *self.dim), dtype='int8')
        ...
        for i, ID in enumerate(list_IDs_temp):
            ...
            dice[i] = np.load(self.dice_path + ID + NPY).astype('float16')
        ...
        x_t = [img, ensemble_pred, flag, dice]
    ...
    def __getitem__(self, index):
        ...
        # Generate data
        [img, ensemble_pred, flag, dice], [pz, cz, us, afs, bg] = self.__data_generation(list_IDs_temp)

        return [img, ensemble_pred, flag, dice], [pz, cz, us, afs, bg]
