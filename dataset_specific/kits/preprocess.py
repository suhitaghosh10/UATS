...
def check_if_segm_in_ROI(cropped_img_right, cropped_img_left, segm):
    ...
    segm_right_cropped = utils.resampleToReference(segm_right, cropped_img_right, sitk.sitkNearestNeighbor, 0,
                                                   out_dType=sitk.sitkUInt8)
    segm_left_cropped = utils.resampleToReference(segm_left, cropped_img_left, sitk.sitkNearestNeighbor, 0,
                                                  out_dType=sitk.sitkUInt8)
