...
from dataset_specific.hippocampus import DataGenerator as train_gen
...
ENS_GT_PATH = '/data/suhita/temporal/hippocampus/output/sadv686799/'
...
def train(gpu_id, nb_gpus, perc):
    ...
    TRAINED_MODEL_PATH = '/data/suhita/hippocampus/output/models/supervised_F_' + str(
