...
if USER_NAME == 'suhita':
    ENS_GT_PATH = '/data/suhita/temporal/skin/output/sm_mc/sadv333/'
...
def train(gpu_id, nb_gpus, perc, batch_nos, learning_rate=None, wts=None, clean=True):
    if USER_NAME == 'suhita':
        NAME = '2_sm_skin_entropy_F' + str(FOLD_NUM) + '_Perct_Labelled_' + str(perc)
        ...
        TRAINED_MODEL_PATH = '/data/suhita/skin/models/softmax_supervised_sfs32_F_' + str(
            FOLD_NUM) + '_1000_5e-05_Perc_' + str(perc) + '_augm.h5'

        # DATA_PATH = '/data/suhita/data/softmax/fold_' + str(FOLD_NUM) + '_P' + str(perc) + '/'
        # FOLD_DIR = '/data/suhita/data/skin/Folds'
        # TRAIN_NUM = len(np.load(FOLD_DIR + '/train_fold' + str(FOLD_NUM) + '.npy'))
        #
        # TB_LOG_DIR = '/data/suhita/data/tb/' + NAME + '_' + str(learning_rate) + '/'
        # MODEL_NAME = '/data/suhita/skin/' + NAME + '.h5'
        # CSV_NAME = '/data/suhita/data/CSV/' + NAME + '.csv'
    #    TRAINED_MODEL_PATH = '/data/suhita/skin/softmax_supervised_sfs32_F_' + str(FOLD_NUM) + \
    ...
    class TemporalCallback(Callback):
        ...
        def __init__(self, data_path, ensemble_path, train_idx_list, clean=True):
    ...
    tcb = TemporalCallback(DATA_PATH, ENS_GT_PATH, train_id_list, clean=clean)
    lcb = wm.LossCallback()
...
if __name__ == '__main__':
    ...
    try:
        ...
        # shutil.rmtree(ENS_GT_PATH)
        train(None, None, perc=1.0, batch_nos=3, learning_rate=1e-7, clean=True)
