...
TB_LOG_DIR = '/data/suhita/temporal/tb/' + NAME + '/'
MODEL_NAME = '/data/suhita/temporal/' + NAME + '.h5'

TRAIN_IMGS_PATH = '/cache/suhita/data/fold2_30/train/imgs/'
TRAIN_GT_PATH = '/cache/suhita/data/fold2_30/train/gt/'

VAL_IMGS_PATH = '/cache/suhita/data/fold2_30/val/imgs/'
VAL_GT_PATH = '/cache/suhita/data/fold2_30/val/gt/'
