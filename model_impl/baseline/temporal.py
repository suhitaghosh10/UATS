...
FOLD_NUM = 1
TB_LOG_DIR = '/data/suhita/temporal/tb/variance_mcdropout/Temporal_ORIG_SUP_NA_F' + str(FOLD_NUM) + '_' + str(
    learning_rate) + '/'
MODEL_NAME = '/data/suhita/temporal/Temporal_ORIG_SUP_NA_F' + str(FOLD_NUM)

CSV_NAME = '/data/suhita/temporal/CSV/Temporal_ORIG_SUP_NA_F' + str(FOLD_NUM) + '.csv'
