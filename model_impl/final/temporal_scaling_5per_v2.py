...
from lib.segmentation.old.model_TemporalEns_ContDice_Regression_v3 import weighted_model
...
FOLD_NUM = 1
TB_LOG_DIR = '/cache/suhita/temporal/tb/variance_mcdropout/scaling_temp_v2_T' + str(TEMP) + '_F' + str(
    FOLD_NUM) + '_' + str(learning_rate) + '/'
MODEL_NAME = '/cache/suhita/temporal/scaling_T_v2' + str(TEMP) + '_F' + str(FOLD_NUM)

CSV_NAME = '/cache/suhita/temporal/CSV/scaling_v2_F' + str(FOLD_NUM) + '.csv'
...
TRAINED_MODEL_PATH = '/cache/suhita/data/model_impl.h5'
# TRAINED_MODEL_PATH = '/cache/suhita/temporal/temporal_sl2.h5'

ENS_GT_PATH = '/cache/suhita/temporal/sadv2/ens_gt/'
FLAG_PATH = '/cache/suhita/temporal/sadv2/flag/'
    ...
    class TemporalCallback(Callback):
        ...
        def __init__(self, imgs_path, gt_path, ensemble_path, supervised_flag_path, train_idx_list):
            ...
            for patient in np.arange(num_train_data):
                ...
                # copy2(TRAIN_GT_PATH+ str(patient) + '.npy', self.gt_path +str(patient) + '.npy')
