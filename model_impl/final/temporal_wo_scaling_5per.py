...
FOLD_NUM = 1
TB_LOG_DIR = '/cache/suhita/temporal/tb/variance_mcdropout/NO_scaling_V2_F' + str(FOLD_NUM) + '_' + str(
    learning_rate) + '/'
MODEL_NAME = '/cache/suhita/temporal/NO_scaling_V2_F' + str(FOLD_NUM)

CSV_NAME = '/cache/suhita/temporal/CSV/NO_scaling_V2_F' + str(FOLD_NUM) + '.csv'
