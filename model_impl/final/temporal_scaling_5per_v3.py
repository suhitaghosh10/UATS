...
FOLD_NUM = 1
TB_LOG_DIR = '/cache/suhita/temporal/tb/variance_mcdropout/scaling_temp_v3_T' + str(TEMP) + '_F' + str(
    FOLD_NUM) + '_' + str(learning_rate) + '/'
MODEL_NAME = '/cache/suhita/temporal/scaling_T_v3' + str(TEMP) + '_F' + str(FOLD_NUM)

CSV_NAME = '/cache/suhita/temporal/CSV/scaling_v3_F' + str(FOLD_NUM) + '.csv'
...
ENS_GT_PATH = '/cache/suhita/temporal/sadv3/ens_gt/'
FLAG_PATH = '/cache/suhita/temporal/sadv3/flag/'
