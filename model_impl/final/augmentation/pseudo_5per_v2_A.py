...
from generator.pseudo_5p_gen import DataGenerator
...
TB_LOG_DIR = '/data/suhita/temporal/tb/variance_mcdropout/pseudo_5per_A_v2_F' + str(FOLD_NUM) + '_' + str(
    learning_rate) + '/'
MODEL_NAME = '/data/suhita/temporal/pseudo_5per_A_v2_F' + str(FOLD_NUM)
...
CSV = '/data/suhita/temporal/CSV/pseudo_5per_A_v2_F' + str(FOLD_NUM) + '.csv'
...
def train(gpu_id, nb_gpus):
    ...
    class TemporalCallback(Callback):
        ...
        def __init__(self, imgs_path, ensemble_path, supervised_flag_path, train_idx_list):
        ...
        def on_epoch_end(self, epoch, logs={}):
            ...
            if epoch > 0:
                ...
                for b_no in np.arange(num_batches):
                    ...
                    # if interval no reached then update pseudolabels
                    if epoch % UPDATE_EPOCH_NO == 0:
                        save_array(self.ensemble_path, cur_pred, start, end)
    ...
    tcb = TemporalCallback(TRAIN_IMGS_PATH, ENS_GT_PATH, FLAG_PATH, train_id_list)
