...
TB_LOG_DIR = '/home/suhita/zonals/temporal/tb/variance_mcdropout/cont_dice_loss_5PER_save_best_us_afs' + str(
    learning_rate) + '/'
MODEL_NAME = '/home/suhita/zonals/temporal/cont_dice_loss_5PER_save_best_us_afs'
...
def train(gpu_id, nb_gpus):
    ...
    class TemporalCallback(Callback):
        ...
        def __init__(self, imgs_path, gt_path, ensemble_path, supervised_flag_path, train_idx_list):
            ...
            with open('/home/suhita/zonals/temporal/suppixelreg_percent_afs_us.csv', 'w') as csvfile:
        ...
        def on_epoch_end(self, epoch, logs={}):
            ...
            if epoch >= 0:
                ...
                for b_no in np.arange(num_batches):
                    ...
                    for zone in np.arange(4):
                        ...
                        if zone == 2 or zone == 3:
                            ...
                            count = np.count_nonzero(final_max_ravel) - 1
                            zone_indices = np.argpartition(final_max_ravel, -count)[-count:]
                ...
                with open('/home/suhita/zonals/temporal/suppixelreg_percent_afs_us.csv', 'a') as csvfile:
                    writer = csv.writer(csvfile, delimiter=',', quotechar='"', quoting=csv.QUOTE_MINIMAL)
