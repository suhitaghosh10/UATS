...
from lib.segmentation.old.model_TemporalEns_ContDice_temp import weighted_model
...
TB_LOG_DIR = '/home/suhita/zonals/temporal/tb/variance_mcdropout/cont_dice_loss_temp' + str(learning_rate) + '/'
MODEL_NAME = '/home/suhita/zonals/temporal/cont_dice_loss_temp'
...
def train(gpu_id, nb_gpus):
    ...
    class TemporalCallback(Callback):
        ...
        def __init__(self, imgs_path, gt_path, ensemble_path, supervised_flag_path, train_idx_list):
            ...
            with open('/home/suhita/zonals/temporal/suppixel.csv', 'w') as csvfile:
        ...
        def on_epoch_end(self, epoch, logs={}):
            ...
            if epoch >= 0:
                ...
                for b_no in np.arange(num_batches):
                    ...
                    flag = np.reshape(max_pred_ravel, (IMGS_PER_ENS_BATCH, 32, 168, 168, 1))
                    del max_pred_ravel
                ...
                with open('/home/suhita/zonals/temporal/suppixel.csv', 'a') as csvfile:
                    writer = csv.writer(csvfile, delimiter=',', quotechar='"', quoting=csv.QUOTE_MINIMAL)
