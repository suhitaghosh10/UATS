...
from lib.segmentation.model_TemporalEns_v2 import weighted_model
...
TB_LOG_DIR = '/home/suhita/zonals/temporal/tb/variance_mcdropout/ONE_dice_loss' + str(learning_rate) + '/'
MODEL_NAME = '/home/suhita/zonals/temporal/temporal_ONE_dice_loss'
            ...
            if epoch >= 0:
                ...
                for b_no in np.arange(num_batches):
                    ...
                    if (b_no == 0):
                        ...
                        logs['pz_dice_coef'] = K.eval(
                            self.dice_coef(y_true[:, :, :, :, 0], model_out[0][0:58, :, :, :]))
                        logs['cz_dice_coef'] = K.eval(
                            self.dice_coef(y_true[:, :, :, :, 1], model_out[1][0:58, :, :, :]))
                        logs['us_dice_coef'] = K.eval(
                        ...
                        cur_pred[0:58, :, :, :, 1] = model_out[1][0:58, :, :, :]
                        cur_pred[0:58, :, :, :, 2] = model_out[2][0:58, :, :, :]
                        cur_pred[0:58, :, :, :, 3] = model_out[3][0:58, :, :, :]
                        cur_pred[0:58, :, :, :, 4] = model_out[4][0:58, :, :, :]
