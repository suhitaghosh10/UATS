...
FOLD_NUM = 1
TB_LOG_DIR = '/home/suhita/zonals/temporal/tb/variance_mcdropout/scaling_temp_v3_T' + str(TEMP) + '_F' + str(
    FOLD_NUM) + '_' + str(learning_rate) + '/'
MODEL_NAME = '/home/suhita/zonals/temporal/scaling_T_v3' + str(TEMP) + '_F' + str(FOLD_NUM)

CSV_NAME = '/home/suhita/zonals/temporal/CSV/scaling_v3_F' + str(FOLD_NUM) + '.csv'
