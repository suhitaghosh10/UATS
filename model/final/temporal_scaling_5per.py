...
FOLD_NUM = 2
TB_LOG_DIR = '/home/suhita/zonals/temporal/tb/variance_mcdropout/scaling_temp_' + str(TEMP) + '_F' + str(
    FOLD_NUM) + '_' + str(learning_rate) + '/'
MODEL_NAME = '/home/suhita/zonals/temporal/scaling_T_' + str(TEMP) + '_F' + str(FOLD_NUM)

CSV_NAME = '/home/suhita/zonals/temporal/CSV/scaling_F' + str(FOLD_NUM) + '.csv'
