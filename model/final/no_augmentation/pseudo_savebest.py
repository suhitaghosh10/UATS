...
learning_rate = 5e-5
FOLD_NUM = 2
TB_LOG_DIR = '/home/suhita/zonals/temporal/tb/variance_mcdropout/pseudo_SB_F' + str(FOLD_NUM) + '_' + str(
    learning_rate) + '/'
MODEL_NAME = '/home/suhita/zonals/temporal/pseudo_SB_F' + str(FOLD_NUM)

CSV_NAME = '/home/suhita/zonals/temporal/CSV/pseudo_SB_F' + str(FOLD_NUM) + '.csv'
