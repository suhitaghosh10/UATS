...
from generator.baseline import DataGenerator as gen
...
learning_rate = 5e-5
FOLD_NUM = 1
TB_LOG_DIR = '/home/suhita/zonals/temporal/tb/variance_mcdropout/pseudo_F' + str(FOLD_NUM) + '_' + str(
    learning_rate) + '/'
MODEL_NAME = '/home/suhita/zonals/temporal/pseudo_F' + str(learning_rate)

CSV_NAME = '/home/suhita/zonals/temporal/CSV/Pseudolabel_F' + str(FOLD_NUM) + '.csv'
