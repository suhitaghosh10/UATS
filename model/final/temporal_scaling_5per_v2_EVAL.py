...
FOLD_NUM = 1
TB_LOG_DIR = '/home/suhita/zonals/temporal/tb/variance_mcdropout/scaling_temp_v2' + str(TEMP) + '_F' + str(
    FOLD_NUM) + '_' + str(learning_rate) + '/'
MODEL_NAME = '/home/suhita/zonals/temporal/scaling_temp_A_3_F1'
