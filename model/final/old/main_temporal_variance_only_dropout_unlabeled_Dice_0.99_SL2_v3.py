...
from lib.segmentation.old.model_TemporalEns_ContDice import weighted_model
...
TB_LOG_DIR = '/home/suhita/zonals/temporal/tb/variance_mcdropout/cont_dice_loss' + str(learning_rate) + '/'
MODEL_NAME = '/home/suhita/zonals/temporal/cont_dice_loss'
