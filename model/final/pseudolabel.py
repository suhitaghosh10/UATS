...
from generator.val_data_gen_baseline import DataGenerator as gen
...
TB_LOG_DIR = '/home/suhita/zonals/temporal/tb/variance_mcdropout/pseudo_F1' + str(learning_rate) + '/'
MODEL_NAME = '/home/suhita/zonals/temporal/pseudo_F1.h5'
FOLD_NUM = 1
CSV_NAME = '/home/suhita/zonals/temporal/CSV/Pseudolabel' + str(FOLD_NUM) + '.csv'
