...
FOLD_NUM = 1
TB_LOG_DIR = '/home/suhita/zonals/temporal/tb/variance_mcdropout/MC_A_F' + str(
    FOLD_NUM) + '_' + str(learning_rate) + '/'
MODEL_NAME = '/home/suhita/zonals/temporal/MC_A_F' + str(FOLD_NUM)

CSV_NAME = '/home/suhita/zonals/temporal/CSV/MC_A_F' + str(FOLD_NUM) + '.csv'
