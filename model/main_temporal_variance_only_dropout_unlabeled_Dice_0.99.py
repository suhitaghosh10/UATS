...
TB_LOG_DIR = '/home/suhita/zonals/temporal/tb/variance_mcdropout/mse_threshold' + str(learning_rate) + '/'
MODEL_NAME = '/home/suhita/zonals/temporal/temporal_mse1.h5'
...
WEIGHT_PATH = '/home/suhita/zonals/temporal/mse/wt/'
ENS_GT_PATH = '/home/suhita/zonals/temporal/mse/ens_gt/'
                ...
                for b_no in np.arange(num_batches):
                    ...
                    if epoch >= SAVE_WTS_AFTR_EPOCH:
                        ...
                        unsupervised_weight = np.where(ensemble_prediction >= 0.99, np.zeros_like(ensemble_prediction),
                                                       np.ones_like(ensemble_prediction))
                        del ensemble_prediction
                        unsupervised_weight[:, :, :, :, 4] = unsupervised_weight[:, :, :, :, 4] * 4 * next_weight
