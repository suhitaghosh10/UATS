...
TB_LOG_DIR = '/home/suhita/zonals/temporal/tb/variance_mcdropout/dice_sad/'
...
WEIGHT_PATH = '/home/suhita/zonals/temporal/dice/wt/'
ENS_GT_PATH = '/home/suhita/zonals/temporal/dice/ens_gt/'
    ...
    model = wm.build_model(num_class=NUM_CLASS, use_dice_cl=True, learning_rate=learning_rate, gpu_id=gpu_id,
        ...
        class TemporalCallback(Callback):
            ...
            def on_epoch_end(self, epoch, logs={}):
                ...
                # DataGenerator(self.imgs_path,self.gt_path,self.ensemble_path, self.weight_path,self.supervised_flag,self.train_idx_list)
