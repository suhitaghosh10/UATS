...
class weighted_model:
    ...
    def build_model(self, img_shape=(32, 168, 168), use_dice_cl=None, num_class=5, learning_rate=5e-5, gpu_id=None,
        ...
        conv_out_sm = Conv3D(5, (1, 1, 1), name='conv_final_softmax_mc')(conv7)
        conv_out_sm = Lambda(lambda x: x / 3, name='scaling')(conv_out_sm)
        conv_out_sm = Activation('softmax')(conv_out_sm)
