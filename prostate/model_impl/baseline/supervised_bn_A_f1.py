...
TRAIN_IMGS_PATH = '/cache/suhita/data/prostate/fold_1/train/imgs/'
TRAIN_GT_PATH = '/cache/suhita/data/prostate/fold_1/train/gt/'

VAL_IMGS_PATH = '/cache/suhita/data/prostate/fold_1/val/imgs/'
VAL_GT_PATH = '/cache/suhita/data/prostate/fold_1/val/gt/'
...
if __name__ == '__main__':
    ...
    train(None, None, trained_model=None, perc=1.0, fold=1)
    # clear_session()
