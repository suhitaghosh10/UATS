...
from lib.segmentation.model.temporalEns_MC_2model_scaled import weighted_model
...
FOLD_NUM = 2
TB_LOG_DIR = '/data/suhita/temporal/tb/variance_mcdropout/MC_Ent_A_F_Scaled' + str(
    FOLD_NUM) + '_' + str(learning_rate) + '/'
MODEL_NAME = '/data/suhita/temporal/MC_Ent_A_F_Scaled' + str(FOLD_NUM)

CSV_NAME = '/data/suhita/temporal/CSV/MC_Ent_A_F_Scaled' + str(FOLD_NUM) + '.csv'
            ...
            if epoch > 0:
                ...
                for b_no in np.arange(num_batches):
                    ...
                    if True:
                        ...
                        flag = np.reshape(entropy_zone, (IMGS_PER_ENS_BATCH, 32, 168, 168))
