...
from lib.segmentation.model.temporal_ORIG import weighted_model
...
FOLD_NUM = 4
TB_LOG_DIR = '/data/suhita/temporal/tb/variance_mcdropout/Temporal_SSL_A_F' + str(FOLD_NUM) + '_' + str(
    learning_rate) + '/'
MODEL_NAME = '/data/suhita/temporal/Temporal_SSL_A_F' + str(FOLD_NUM)

CSV_NAME = '/data/suhita/temporal/CSV/Temporal_SSL_A_F' + str(FOLD_NUM) + '.csv'
...
ENS_GT_PATH = '/data/suhita/temporal/sadv1/ens_gt/'
FLAG_PATH = '/data/suhita/temporal/sadv1/flag/'
