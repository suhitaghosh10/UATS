...
from generator.temporal import DataGenerator as train_gen
...
def train(gpu_id, nb_gpus, perc):
    ...
    TRAIN_NUM = 58
    NAME = 'NA_prostate_softmax_F' + str(FOLD_NUM) + '_Perct_Labelled_' + str(PERCENTAGE_OF_LABELLED) + '_Pix' + str(
    ...
    class TemporalCallback(Callback):
        ...
        def __init__(self, data_path, ensemble_path, train_idx_list):
            ...
            flag = np.ones(shape=DIM, dtype='int64')
            ...
            for patient in np.arange(num_train_data):
                ...
                if patient < num_labeled_train:
                    ...
                    np.save(os.path.join(self.ensemble_path, 'flag', str(patient) + '.npy'),
                            np.zeros(shape=DIM, dtype='int64'))
        ...
        def on_epoch_end(self, epoch, logs={}):
            ...
            if epoch > 0:
                ...
                for b_no in np.arange(num_batches):
                    ...
                    supervised_flag = get_array(self.ensemble_path + '/flag/', start, end, dtype='int64')
