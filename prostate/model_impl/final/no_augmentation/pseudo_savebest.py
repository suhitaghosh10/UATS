...
learning_rate = 5e-5
FOLD_NUM = 2
TB_LOG_DIR = '/data/suhita/temporal/tb/variance_mcdropout/pseudo_SB_F' + str(FOLD_NUM) + '_' + str(
    learning_rate) + '/'
MODEL_NAME = '/data/suhita/temporal/pseudo_SB_F' + str(FOLD_NUM)

CSV_NAME = '/data/suhita/temporal/CSV/pseudo_SB_F' + str(FOLD_NUM) + '.csv'
