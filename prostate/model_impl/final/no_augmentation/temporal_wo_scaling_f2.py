...
TRAIN_IMGS_PATH = '/cache/suhita/data/prostate/fold_2_P1.0/train/'
# TRAIN_UNLABELED_DATA_PRED_PATH = '/cache/suhita/data/training/ul_gt/'

VAL_IMGS_PATH = '/cache/suhita/data/prostate/fold_2_P1.0/val/imgs/'
VAL_GT_PATH = '/cache/suhita/data/prostate/fold_2_P1.0/val/gt/'

TRAINED_MODEL_PATH = '/data/suhita/prostate/supervised_F2_P1.0.h5'
...
makedir(ENS_GT_PATH)
makedir(os.path.join(ENS_GT_PATH, 'flag'))
makedir(os.path.join(ENS_GT_PATH, 'ens_gt'))
