...
from generator.old.data_gen_optim_dice import DataGenerator
from lib.segmentation.old.model_TemporalEns_ContDice_scaled_sad import weighted_model
from lib.segmentation.ops import ramp_down_weight
from lib.segmentation.parallel_gpu_checkpoint import ModelCheckpointParallel
from lib.segmentation.utils import get_complete_array, get_array, save_array, save_dice_array
from zonal_utils.AugmentationGenerator import *

# 294 Training 58 have gt
learning_rate = 2.5e-5
TB_LOG_DIR = '/home/suhita/zonals/temporal/tb/variance_mcdropout/cont_dice_loss_5PER_save_best_sad' + str(
    learning_rate) + '/'
MODEL_NAME = '/home/suhita/zonals/temporal/cont_dice_loss_5PER_save_best_sad'
...
DICE_PATH = '/home/suhita/zonals/temporal/sad/flag/'
FLAG_PATH = '/home/suhita/zonals/temporal/sad/dice/'

CSV = '/home/suhita/zonals/temporal/suppixelreg_percentsad.csv'
...
def train(gpu_id, nb_gpus):
    ...
    class TemporalCallback(Callback):
        ...
        def __init__(self, imgs_path, gt_path, ensemble_path, supervised_flag_path, dice_path, train_idx_list):
            ...
            dice_one = np.ones((1, 1, 1, 5)).astype('float16') * (1 / 1.5)
            ...
            for patient in np.arange(num_train_data):
                ...
                if patient < num_labeled_train:
                    ...
                    np.save(self.dice_path + str(patient) + '.npy', dice_one)
                else:
                    np.save(self.supervised_flag_path + str(patient) + '.npy', np.zeros((32, 168, 168)))
                    np.save(self.dice_path + str(patient) + '.npy', dice_one)
        ...
        def on_epoch_end(self, epoch, logs={}):
            ...
            if epoch >= 0:
                ...
                for b_no in np.arange(num_batches):
                    ...
                    dice = get_array(self.dice_path, start, end, dtype='float16')

                    inp = [imgs, ensemble_prediction, supervised_flag, dice]
                    ...
                    save_dice_array(self.dice_path, cur_pred, ensemble_prediction, start, end)
    ...
    tcb = TemporalCallback(TRAIN_IMGS_PATH, TRAIN_GT_PATH, ENS_GT_PATH, FLAG_PATH, DICE_PATH, train_id_list)
    ...
    dice = np.ones((num_val_data, 1, 1, 1, 5), dtype='int8')
    ...
    x_val = [val_x_arr, val_y_arr, val_supervised_flag, dice]
