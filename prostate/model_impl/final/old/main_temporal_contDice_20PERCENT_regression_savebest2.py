...
TEMP = 3
TB_LOG_DIR = '/home/suhita/zonals/temporal/tb/variance_mcdropout/cont_dice_loss_5PER_save_best_fold3_2' + str(
    learning_rate) + '/'
...
TRAINED_MODEL_PATH = '/home/suhita/zonals/temporal/anneke_old5e-05_final_less_data'
...
CSV = '/home/suhita/zonals/temporal/suppixelreg_percent2.csv'
...
def train(gpu_id, nb_gpus):
    ...
    if nb_gpus is not None and nb_gpus > 1:
        model_checkpoint = ModelCheckpointParallel(MODEL_NAME,
                                                   monitor='val_afs_dice_coef',
                                                   save_best_only=True,
                                                   verbose=1,
                                                   mode='max')
    else:
        model_checkpoint = ModelCheckpoint(MODEL_NAME, monitor='val_afs_dice_coef',
                                           save_best_only=True,
                                           verbose=1,
                                           mode='max')
