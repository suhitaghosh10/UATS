...
from prostate.generator.AugmentationGenerator import get_single_image_augmentation_with_only_ensemble
...
class DataGenerator(keras.utils.Sequence):
    ...
    def __data_generation(self, list_IDs_temp):
        ...
        x_t = [img, ensemble_pred]
        y_t = [pz_gt, cz_gt, us_gt, afs_gt, bg_gt]
        del gt, img, ensemble_pred
    ...
    def __getitem__(self, index):
        ...
        # Generate data
        [img, ensemble_pred], [pz_gt, cz_gt, us_gt, afs_gt, bg_gt] = self.__data_generation(list_IDs_temp)

        return [img, ensemble_pred], [pz_gt, cz_gt, us_gt, afs_gt, bg_gt]
