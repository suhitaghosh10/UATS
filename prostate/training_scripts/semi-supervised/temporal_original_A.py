...
from prostate.model.temporal_original import weighted_model
from utility.callbacks.temporal import TemporalCallback
from utility.constants import *
from utility.parallel_gpu_checkpoint import ModelCheckpointParallel
from utility.prostate.utils import get_temporal_prostate_val_data
...
def train(gpu_id, nb_gpus, temp_path, labelled_percentage, fold_num, name, lr=LR):
    ...
    tcb = TemporalCallback(PROSTATE_DIM, DATA_PATH, ens_path, SAVE_PATH, num_train_data, num_labeled_train,
                           PATIENTS_PER_BATCH, nr_class=5, batch_size=BATCH_SIZE, dataset_name=PROSTATE_DATASET)
    ...
    x_val, y_val = get_temporal_prostate_val_data(DATA_PATH)
...
if __name__ == '__main__':
    ...
    try:
        ...
        name = 'test_temporal_F' + str(fold_num) + '_Perct_Labelled_' + str(perc)
