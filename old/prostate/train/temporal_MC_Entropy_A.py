...
FOLD_NUM = 3
TB_LOG_DIR = '/data/suhita/temporal/tb/variance_mcdropout/MC_Ent_A_F' + str(
    FOLD_NUM) + '_' + str(learning_rate) + '/'
MODEL_NAME = '/data/suhita/temporal/MC_Ent_A_F' + str(FOLD_NUM)

CSV_NAME = '/data/suhita/temporal/CSV/MC_Ent_A_F' + str(FOLD_NUM) + '.csv'
