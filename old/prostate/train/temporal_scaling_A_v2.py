...
FOLD_NUM = 1
TRAIN_NUM = 40
NAME = 'sad' + str(FOLD_NUM) + '_' + str(TRAIN_NUM) + '_' + str(TEMP)
...
TEMP_WTS = '/data/suhita/temporal/sadv1/temp.h5'
        ...
        def on_epoch_end(self, epoch, logs={}):
            ...
            if epoch > 0:
                ...
                for b_no in np.arange(num_batches):
                    ...
                    if b_no == 0:
                        model.save_weights(TEMP_WTS, overwrite=True)

                    p_model = wm.build_model(num_class=NUM_CLASS, use_dice_cl=False, learning_rate=learning_rate,
                                             gpu_id=gpu_id,
