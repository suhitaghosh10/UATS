                ...
                for b_no in np.arange(num_batches):
                    ...
                    if True:
                        ...
                        for i in np.arange(T):
                            ...
                            mc_pred_sq[:, :, :, :, 0] = np.add(mc_pred_sq[:, :, :, :, 0], model_out[0] * model_out[0])
                            mc_pred_sq[:, :, :, :, 1] = np.add(mc_pred_sq[:, :, :, :, 1], model_out[1] * model_out[1])
                            mc_pred_sq[:, :, :, :, 2] = np.add(mc_pred_sq[:, :, :, :, 2], model_out[2] * model_out[2])
                            mc_pred_sq[:, :, :, :, 3] = np.add(mc_pred_sq[:, :, :, :, 3], model_out[3] * model_out[3])
                            mc_pred_sq[:, :, :, :, 4] = np.add(mc_pred_sq[:, :, :, :, 4], model_out[4] * model_out[4])
