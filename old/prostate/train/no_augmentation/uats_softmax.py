...
FOLD_NUM = 3
TB_LOG_DIR = '/data/suhita/temporal/tb/variance_mcdropout/NO_scaling_F' + str(FOLD_NUM) + '_' + str(
    learning_rate) + '/'
MODEL_NAME = '/data/suhita/temporal/NO_scaling_F' + str(FOLD_NUM)

CSV_NAME = '/data/suhita/temporal/CSV/NO_scaling_F' + str(FOLD_NUM) + '.csv'

TRAIN_IMGS_PATH = '/cache/suhita/data/prostate/fold_3_P1.0/train/'
# TRAIN_UNLABELED_DATA_PRED_PATH = '/cache/suhita/data/training/ul_gt/'

VAL_IMGS_PATH = '/cache/suhita/data/prostate/fold_3_P1.0/val/imgs/'
VAL_GT_PATH = '/cache/suhita/data/prostate/fold_3_P1.0/val/gt/'

TRAINED_MODEL_PATH = '/data/suhita/prostate/supervised_F3_P1.0.h5'
# TRAINED_MODEL_PATH = '/cache/suhita/temporal/temporal_sl2.h5'

ENS_GT_PATH = '/data/suhita/temporal/sadv388/'
