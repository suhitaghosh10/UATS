...
def train(gpu_id, nb_gpus, perc, imgs_per_batch):
    NAME = 'softmax_F' + str(FOLD_NUM) + '_' + str(perc)
    ...
    TRAIN_IMGS_PATH = '/cache/suhita/data/fold' + str(FOLD_NUM) + '_' + str(perc) + '/train/imgs/'
    TRAIN_GT_PATH = '/cache/suhita/data/fold' + str(FOLD_NUM) + '_' + str(perc) + '/train/gt/'

    VAL_IMGS_PATH = '/cache/suhita/data/fold' + str(FOLD_NUM) + '_' + str(perc) + '/val/imgs/'
    VAL_GT_PATH = '/cache/suhita/data/fold' + str(FOLD_NUM) + '_' + str(perc) + '/val/gt/'

    TRAINED_MODEL_PATH = '/data/suhita/temporal/' + 'supervised_F' + str(FOLD_NUM) + '_' + str(perc) + '.h5'

    num_labeled_train = perc * 58  # total no of labelled examples: 58
