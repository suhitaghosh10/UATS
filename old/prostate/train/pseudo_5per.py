...
TB_LOG_DIR = '/data/suhita/temporal/tb/variance_mcdropout/pseudo_5per_F' + str(FOLD_NUM) + '_' + str(
    learning_rate) + '/'
MODEL_NAME = '/data/suhita/temporal/pseudo_5per_F' + str(FOLD_NUM)
...
CSV = '/data/suhita/temporal/CSV/pseudo_5per_F' + str(FOLD_NUM) + '.csv'
